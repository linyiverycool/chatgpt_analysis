...
void Set2_Hand(void)
{
    ...
    if((AN1_flag==1)&&(AuRun_Flag!=1))
    {
        ...
        case 7:		// 结束采摘;归0;
            ...
            break;
        case 8:
            Pick_time1=(Pick_time_M*5)-Pick_time2;
            MOT_DirZ=0;
            Apple_Pick=1;
            break;
        case 9:
    ...
    else if((AN1_flag==0)&&(Apple_Pick!=0))
    {
        ...
        {
        case 1:		// 01异常;
            Pick_time2=(Pick_time_M*5)-Pick_time1;
            MOT_DirZ=0;
            Apple_Pick=8;
            break;
        case 2:		// 02异常;
            Pick_time2=Pick_time1;
            MOT_DirZ=0;
            Apple_Pick=9;
            break;
        case 3:		// 正常03;
...
void Set1_Area(void)
{
    ...
    {
    case 1:
        if(Set_Wei>5)	Set_Wei=Set_Wei-6;
        break;	// 向上;
    case 5:
        if(Set_Wei<6)	Set_Wei=Set_Wei+6;
        break;	// 向下;
    case 9:
...
void Area_Init(void)
{
    ...
    Stop_Y  = SpY;
    Set_Data[0] = SrX/100;
    Set_Data[1] = SrX/10%10;
    Set_Data[2] = SrX%10;
    Set_Data[3] = SrY/100;
    Set_Data[4] = SrY/10%10;
    Set_Data[5] = SrY%10;
    Set_Data[6] = SpX/100;
    Set_Data[7] = SpX/10%10;
    Set_Data[8] = SpX%10;
    Set_Data[9] = SpY/100;
    Set_Data[10] = SpY/10%10;
    Set_Data[11] = SpY%10;
}
