...
/**********************************************************************************************************
* Function    ：void MOTOR_Set(void)
* Description : X,Y轴电机控制程序
* Para        : none
* Return(s)   : none
* Example     : MOTOR_Set();
**********************************************************************************************************/
void MOTOR_Set(void)
{
    ...
    case 1:	// 归零位;
        if(Grid_init==0)
        {
            ...
            if(Grid0_Num>1)
            {
                ...
                else if((OUTX_Flag==0)&&(MOT_DirX!=0)) {
                    MOT_FlagX=1;
                }
                if(OUTY_Flag==1)	OUTY_Flag=0;
                else if((OUTY_Flag==0)&&(MOT_DirY!=0)) {
                    MOT_FlagY=1;
                }
            }
            MOT_DirZ=2;
    ...
    case 5:	// 退回到 PreDa_X==Start_X && PreDa_Y==Start_Y 位置;采摘前位置;
        ...
        ///if(Run_Y<PreDa_Y)		{ MOT_DirY=1; MOT_FlagY=0; }// 上移;
        //else if(Run_Y>PreDa_Y)	{ MOT_DirY=2; MOT_FlagY=0; }// 下移;
...
/**********************************************************************************************************
* Function    ：void Motor_Run(void)
* Description : X,Y轴电机状态给定程序
* Para        : none
* Return(s)   : none
* Example     : Motor_Run();
**********************************************************************************************************/
